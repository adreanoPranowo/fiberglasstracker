                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($d->status_approved == 1)
                                                <span class="badge bg-success" style="color: white">Di Setujui</span>
                                            @elseif ($d->status_approved == 2)
                                            <span class="badge bg-danger" style="color: white">Di Tolak</span>
                                            @else
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <a href="/presensi/{{ $d->id }}/batalkanizinsakit" class="btn btn-sm bg-danger" style="color: white">
