                ...
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <div class="form-group">
                                            <input type="text" name="nama_dpt" id="nama_dpt" value="{{ Request('nama_dpt') }}" class="form-control" placeholder="Departemen">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <div class="btn-group">
                                        <a href="#" class="edit btn btn-info btn-sm" kode_dpt="{{ $d->kode_dpt }}">
                                ...
                                <form action="/departemen/{{ $d->kode_dpt }}/delete" method="POST"  style="margin-left : 5px">
                                    @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <form action="/departemen/store" method="POST"  id="frmDepartemen">
                ...
                <div class="row">
                    <div class="col-12">
                    <div class="form-label">Masukan Kode Departemen</div>
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" value="" id="kode_dpt" class="form-control" name="kode_dpt"  placeholder="Kode Departemen">
                    </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                    <div class="form-label">Masukan Nama Departemen</div>
                    <div class="input-icon mb-3">
                        <span class="input-icon-addon">
                        ...
                        <input type="text" value="" id="nama_dpt" class="form-control" name="nama_dpt" placeholder="Nama Departemen">
                    </div>
                    </div>
                </div>
                <div class="row mt-4">
